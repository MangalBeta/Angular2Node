...
var PageScrollService = (function () {
    ...
    PageScrollService.prototype.start = function (pageScrollInstance) {
        ...
        var tooShortInterval = pageScrollInstance.duration <= PageScrollConfig._interval;
...
var PageScrollInstance = (function () {
    ...
    PageScrollInstance.simpleInstance = function (document, scrollTarget, namespace) {
        return PageScrollInstance.simpleDirectionInstance(document, scrollTarget, true, namespace);
    };
    /**
     ...
     */
    PageScrollInstance.simpleDirectionInstance = function (document, scrollTarget, isVerticalScrolling, namespace) {
        return PageScrollInstance.advancedInstance(document, scrollTarget, null, namespace, isVerticalScrolling, null, null, null, null, null);
    };
    /**
    ...
    PageScrollInstance.simpleInlineInstance = function (document, scrollTarget, scrollingView, namespace) {
        return PageScrollInstance.simpleInlineDirectionInstance(document, scrollTarget, scrollingView, true, namespace);
    };
    PageScrollInstance.simpleInlineDirectionInstance = function (document, scrollTarget, scrollingView, isVerticalScrolling, namespace) {
        return PageScrollInstance.advancedInstance(document, scrollTarget, [scrollingView], namespace, isVerticalScrolling, null, null, null, null, null);
    };
    /**
     *
     * @param document The document that contains the body to be scrolled and the scrollTarget elements
     ...
     * @returns {PageScrollInstance}
     */
    PageScrollInstance.advancedInstance = function (document, scrollTarget, scrollingViews, namespace, isVerticalScrolling, pageScrollOffset, pageScrollInterruptible, pageScrollEasingLogic, pageScrollDuration, pageScrollFinishListener) {
...
var PageScroll = (function () {
    ...
    PageScroll.prototype.generatePageScrollInstance = function () {
        if (PageScrollUtilService.isUndefinedOrNull(this.pageScrollInstance)) {
            this.pageScrollInstance = PageScrollInstance.advancedInstance(this.document, this.href, null, this.pageScroll, !this.pageScrollHorizontal, this.pageScrollOffset, this.pageScrollInterruptible, this.pageScrollEasing, this.pageScrollDuration, this.pageScrollFinish);
        }
